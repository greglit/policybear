      ...
      <b-container>
        ...
        <b-row class="mb-5 mt-md-5">
          ...
          <b-col cols="12" md="6" class="text-left p-2">
            ...
            <b-button :to="`editor/`" variant="border-0" class="nord-btn-primary mr-2 mb-2">Start creating!</b-button>
            <a href="#examples" v-smooth-scroll>
              <b-button variant="outline-primary" class="nord-btn mr-2 mb-2">Show examples</b-button>
            </a>
          </b-col>
        </b-row>
      </b-container>
