<template>
  <div>
    ...
    <ul>
      <li>
        <p>
          ...
          this Agreement) refers to Policy Bear.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Policy Bear, accessible from
          <a
            href="https://www.policybear.gregl.it/"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.policybear.gregl.it/</a
          >
        </p>
      </li>
      <li>
    ...
    <h3>Personal Data</h3>
    <p>
      No contact information or other personal data is collected. We only collect data about what
      paramethers, stations, time frames and stylings a user selects in the
      policy editor.
    </p>
    <h3>Usage Data</h3>
    ...
    <p>
      We don't use own Cookies or other tracking technologies on our site. The following third party services may use such technologies. For further information please consider their privacy policies.
    </p>
    <ul>
      <li>
    ...
    <ul>
      <li>
        <p>By email: policybear@gregl.it</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:
          <a
            href="https://www.policybear.gregl.it/contact"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.policybear.gregl.it/contact</a
          >
        </p>
      </li>
    </ul>
